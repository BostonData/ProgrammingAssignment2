## Below are two functions that are used to create a special matrix object that stores a matrix and cache's its inverse.
...
##Otherwise, it calculates the inverse of the data and sets the value of the inverse in the cache via the set.inverse function.
